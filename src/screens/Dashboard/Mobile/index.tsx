...
const DashboardMobile = (props: IDashboardProps): JSX.Element => {
  const {
    handleAddNewCard,
    handleCardSelection,
    availableCards,
      ...
      <div className={styles.mainContainer}>
        <div className={styles.temp}>
          <div className="d-flex align-items-end justify-content-between">
            <div>
              <p className={`mb-2 ${styles.balanceHeading}`}>
                Available Balance
              </p>
              <div className="d-flex align-items-center">
                <div className={`${styles.currencyTag}`}>S$</div>
            ...
            >
              <img src={AddIcon} alt="" />
              <p className="m-0 ms-2">New card</p>
            </div>
          </div>
        ...
        <DialogBox isVisible={showAddCardForm} closeHandler={closeHandler}>
          ...
          <div className={`d-flex justify-content-end pt-3 ${styles.addCardModal}`}>
        ...
        >
          <div className={styles.confirmationModal}>
            ...
            <div className="d-flex justify-content-end">
              ...
              <button className="btn btn-outline-danger" onClick={closeHandler}>
                No
              </button>
            </div>
          </div>
        ...
        <div className="p-4">
          ...
          >
            <div className="accordion-body">
              ...
              />
              <CardDetailRow title={"CVV"} value={selectedCard?.cvv || "XXX"} />
            </div>
          </Accordion>
          <Accordion
...
export default withDashboardMethods(DashboardMobile);
